...
class PatientCalendarController extends Controller
{
    ...
    private $DocTransName = "Patient Calendar";
    /**
    ...
    public function index($PatientId)
    {
        ...
        $strsql ="select count(*) as TotalPatientResult from StimulatingPhases as d
        ...
        $strsql ="select count(*) as TotalPatientResult from FreshPhases as d
                    where d.patientid=".$PatientId;
