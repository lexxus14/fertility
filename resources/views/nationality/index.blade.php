        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              	<a href="{{route('NationalityCreate')}}" class="btn btn-primary btn-block"><b>Add New Nationality</b></a>
          ...
          <div class="col-md-9">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Nationality Table</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                        ...
                        <a href="{{route('NationalityEdit')}}/{{$nationality->id}}" class=" badge bg-success">Edit</button></a>&nbsp
                        <button type="button" class=" badge bg-danger open-modal-delete" data-toggle="modal" data-target="#modal-delete" value="{{$nationality->id}}">Delete</button>
                      <!-- </form> -->
                    </td>
                  </tr>    
                  @endforeach                            
      ...
      <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="POST" action="{{route('NationalityDelete')}}">
              {{ csrf_field() }}
