...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     <form action="{{route('ClomidCycleStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
          {{ csrf_field() }}
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-2">
                      <div class="form-group">
                        <label>LMP</label>
                          <input type="date" class="form-control" name="LMPDAte"/>
                      </div>
                  </div>
                </div>
                <hr>
                  ...
                  <div class="col-2">
                      <div class="form-group">
                        <label>Start Clomid</label>
                          <input type="date" class="form-control" name="DateStartClomid"/>
                      </div>
                  </div>
                  <div class="col-2">
                      <div class="form-group">
                        <label>Clomid</label>
                          <input type="text" class="form-control" name="Clomidmg" placeholder="mg" />
                      </div>
                  </div>
                  <div class="col-2">
                      <div class="form-group">
                        <label>Days</label>
                          <input type="text" class="form-control" name="ClomidXDays" placeholder="x days" />
                      </div>
                  </div>
                </div>
                <hr>
                  ...
                  <div class="col-2">
                      <div class="form-group">
                        <label>Clomid Consent Date</label>
                          <input type="date" class="form-control" name="ClomidConsendDate"/>
                      </div>
                  </div>
                </div>
                <hr>
                  ...
                  <div class="col-2">
                      <div class="form-group">
                        <label>Beta 1 HCG</label>
                          <input type="text" class="form-control" name="BetaHCG1"/>
                      </div>
                  </div>
                  <div class="col-2">
                      <div class="form-group">
                        <label>Date</label>
                          <input type="date" class="form-control" name="Beta1HCGDate"/>
                      </div>
                  </div>
                  <div class="col-2">
                      <div class="form-group">
                        <label>Beta 2 HCG</label>
                          <input type="text" class="form-control" name="BetaHCG2"/>
                      </div>
                  </div>   
                  <div class="col-2">
                      <div class="form-group">
                        <label>Date</label>
                          <input type="date" class="form-control" name="BetaHCG2Date"/>
                      </div>
                  </div>             
                </div>
                <hr>
