          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-body">               
                ...
                <a href="{{route('PatientCalendarIndex')}}/{{$intPatientId}}" class="btn btn-app bg-secondary">                  
                  <i class="fas fa-user-plus"></i> Calendar
                </a>
              </div>
              <!-- /.card-body -->
            </div>
    	...
    	<div class="container-fluid">
    		<div class="row">
	          ...
	          <div class="col-md-12">
	            <div class="card">
	              <div class="card-header">
	                <h3 class="card-title"><b>Clomid Cycle</b></h3>
                  ...
                  <a href="{{route('ClomidCycleCreate')}}/{{$intPatientId}}" class="btn btn-success float-right" style="margin-right: 5px;">
                    <i class="fas fa-pencil-alt"></i> New
                  </a>
	              </div>
	              <!-- /.card-header -->
	                  ...
	                  <tbody>
	                    <?php
		                  ...
		                  <tr>
		                    ...
		                    <td>{{$result->Notes}}</td>
		                    <td>
		                      <a class="btn btn-primary btn-sm float-right" href="{{route('ClomidCycleShow')}}/{{$result->id}}">
		                        <i class="fas fa-folder"></i>
		                              View
		                      </a>

		                      <a class="btn btn-info btn-sm float-right" href="{{route('ClomidCycleEdit')}}/{{$result->id}}">
      ...
      <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="POST" action="{{route('ClomidCycleDelete')}}">
              {{ csrf_field() }}
              ...
              <input type="hidden" name="intPatientId" value="{{$intPatientId}}">
            </form>
          </div>
          <!-- /.modal-content -->
        </div>
