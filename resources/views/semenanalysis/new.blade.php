                    ...
                    <div class="card-body table-responsive p-0">
                      <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>Sperm Count</td>
                            <td><input type="number" class="form-control" name="SpermCount"> </td>
                            <td>>=15 Million /ml </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td><input type="text" class="form-control" name="Cryptozoospermia"> </td>
                            <td></td>
                          </tr>
                          <tr>
                            <td>Progressive Motility (a+b)</td>
                            <td><input type="number" class="form-control" name="ProgMotility"> </td>
                            <td>>=39 %</td>
                          </tr>
                          <tr>
                            <td>Progression</td>
                    ...
                    <div class="card-body table-responsive p-0">
                      <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                          <tr>
                            <td>Normal Form</td>
                            <td><input type="number" class="form-control" name="NorForm" placeholder="%"> </td>
                            <td>>= 4% </td>
                          </tr>
                          <tr>
                            <td>Abnormal Head</td>
                          ...
                          <tr>
                            ...
                            <td><input type="number" class="form-control" name="AbMid" placeholder="%"> </td>
                            <td></td>
                          </tr>
                          <tr>
                            <td>Abnormal Tail</td>
