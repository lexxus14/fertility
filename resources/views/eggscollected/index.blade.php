        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              	<a href="{{route('EggCollectedCreate')}}/1" class="btn btn-primary btn-block"><b>Add New Eggs Collected</b></a>
