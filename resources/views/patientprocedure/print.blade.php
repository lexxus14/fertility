...
<?php
  ...
  $pdf->Cell(0,10,"Patient Procedure",0,1,'C');
  $DocDate =0;
  ...
  foreach($patients as $patient){
    ...
    foreach($docresults as $docresult)
    {
      ...
      // Colors, line width and bold font
        ...
        $fill = false;
        $intCtr=0;
        foreach($patientproceduresubs as $item)
        {
          ...
          $pdf->Cell($w[1],($line * $cellHeight),$item->procedures,'LR',0,'L',$fill); //adapt height to number of lines
