...
@section('content')
  ...
  <section class="content">
   <form id="quickForm" action="{{route('PatientProcedureUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
                      ...
                      <label>Medicine</label>
                        <select class="form-control select2" name="cmbMedicine" style="width: 100%;">
                           @foreach($procedures as $procedure)
                            @if($result->procedureId == $procedure->id)
                              <option value="{{$procedure->id}}" selected>{{$procedure->description}}</option>
                              @else
              ...
              <div class="row">
                <div class="col-12">
                  <a href="{{route('PatientProcedure')}}/{{$intPatientId}}" class="btn btn-secondary">Cancel</a>
