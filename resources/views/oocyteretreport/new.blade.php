...
@section('content')
  ...
  <section class="content">
   <form action="{{route('OOcyteRetReportStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" id="quickForm" novalidate="">
        {{ csrf_field() }}
            ...
            <div class="card-body">
              ...
              <div class="form-group row">                
                ...
                <div class="col-md-3">
                  ...
                  <input type="number" class="form-control" id="TotalNumberOfEggs" name="TotalNumberOfEggs"/>
                </div>
              </div>
