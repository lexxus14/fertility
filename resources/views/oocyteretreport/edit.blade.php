...
@section('content')
  ...
  <section class="content">
   ...
   <form action="{{route('OOcyteRetReportUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" id="quickForm" novalidate="">
        {{ csrf_field() }}
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            @endif
            <div class="card-header">
              <h3 class="card-title">OOctye Retrieval Report</h3>
            ...
            <div class="card-body">
              ...
              <div class="form-group row">                
                ...
                <div class="col-md-3">
                  <label for="TotalNumberOfEggs" class="col-form-label">Total Number Of Eggs</label>
                  <input type="number" class="form-control" id="TotalNumberOfEggs" name="TotalNumberOfEggs" value="{{$docresult->TotalNumberOfEggs}}"/>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-12">
                  <a href="{{route('OOcyteRetReport')}}/{{$intPatientId}}" class="btn btn-secondary">Cancel</a>
