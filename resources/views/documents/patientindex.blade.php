	                  ...
	                  <tbody>
	                    <?php
		                  ...
		                  <tr>
		                    ...
		                    <td><a href="{{url('/')}}/{{$result->filelink}}">{{$result->filelink}}</a></td>
		                    <td>{{$result->notes}}</td>
		                    <td>
		                      <a class="btn btn-primary btn-sm float-right" href="{{route('DocumentShow')}}/{{$result->id}}">
		                        <i class="fas fa-folder"></i>
		                              View
		                      </a>

		                      <a class="btn btn-info btn-sm float-right" href="{{route('DocumentEdit')}}/{{$result->id}}">
      ...
      <div class="modal fade" id="modal-show">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form id="quickForm" action="{{route('DocumentStore')}}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
      ...
      <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="POST" action="{{route('DocumentDelete')}}">
              {{ csrf_field() }}
              <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
