...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
     ...
     <form action="{{route('FreshFormLongProUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
          {{ csrf_field() }}
...
<script>
  $(function () {
    ...
    var rowIdx_cd = {{$intctrSubs}}-1;     
    var rowIdx_obus = {{$intctrProgs}}-1;        
