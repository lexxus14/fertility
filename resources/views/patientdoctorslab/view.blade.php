            ...
            <div class="card-body">
                ...
                <!-- /.card-header -->
                    ...
                    <table  class="table table-bordered table-striped">
                      ...
                      <tr id="R{{$intctr}}">
                        ...
                        <td class="text-center">
                          <div>{{$patientdoctorlabsub->notes}}</div>
                        </td>
                      </tr>
                      @endforeach
              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <a href="{{route('PatientDoctorsLabPrint')}}/{{$docresult->id}}" target="_blank" class="btn btn-secondary float-right">Print</a>
                </div>
              </div>
            <!-- /.card-body -->
          </div>
      ...
      $.get(url + '/' + med_id, function (data) {
        console.log(data);
            $('#tbody').append(`<tr id="R${++rowIdx}">
              <td class="row-index text-center">
              <input type="hidden" class="medid" name="txtdoctordiagnosisId[]" value="${data.id}">
                <p>${rowIdx}</p>
              </td>
              <td class="text-center">
              ${data.description}
