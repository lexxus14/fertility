    	...
    	<div class="container-fluid">
    		<div class="row">
	          ...
	          <div class="col-md-12">
	            <div class="card">
	              <div class="card-header">
	                <h3 class="card-title"><b>Doctor's Lab Test</b></h3>
                  ...
                  <a href="{{route('PatientDoctorsLabCreate')}}/{{$intPatientId}}" class="btn btn-success float-right" style="margin-right: 5px;">
                    <i class="fas fa-pencil-alt"></i> New
                  </a>
	              </div>
	              <!-- /.card-header -->
                          ...
                          {{$result->filelink}}
                           @endif   </td>
		                    ...
		                    <td>
		                      ...
		                      <a class="btn btn-info btn-sm float-right" href="{{route('PatientDoctorsLabEdit')}}/{{$result->id}}">
      ...
      <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="POST" action="{{route('PatientDoctorsLabDelete')}}">
              {{ csrf_field() }}
