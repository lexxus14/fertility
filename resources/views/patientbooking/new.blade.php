...
@section('content')
  ...
  <section class="content">
    <form action="{{route('PatientBookingStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
                  ...
                  <div class="bootstrap-timepicker">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="timepicker" data-target-input="nearest">
                        <input type="text" name="txtBookedTime" class="form-control datetimepicker-input" data-target="#timepicker">
