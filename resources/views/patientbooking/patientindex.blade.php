    	...
    	<div class="container-fluid">
    		<div class="row">
	          ...
	          <div class="col-md-12">
	            <div class="card">
	              <div class="card-header">
	                <h3 class="card-title"><b>Patient's Booking</b></h3>
                  ...
                  <a href="{{route('PatientBookingCreate')}}/{{$intPatientId}}" class="btn btn-success float-right" style="margin-right: 5px;">
                    <i class="fas fa-pencil-alt"></i> New
                  </a>
	              </div>
	              <!-- /.card-header -->
	                  ...
	                  <tbody>
	                    <?php
		                  ...
		                  <tr>
		                    ...
		                    <td>{{$result->bookedtime}}</td>
		                    <td>{{$result->name}}</td>
                        <td>{{$result->description}}</td>
		                    <td>{{$result->notes}}</td>
		                    <td>
		                      <a class="btn btn-primary btn-sm float-right" href="{{route('PatientBookingShow')}}/{{$result->id}}">
		                        <i class="fas fa-folder"></i>
		                              View
		                      </a>

		                      <a class="btn btn-info btn-sm float-right" href="{{route('PatientBookingEdit')}}/{{$result->id}}">
      ...
      <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="POST" action="{{route('PatientBookingDelete')}}">
              {{ csrf_field() }}
