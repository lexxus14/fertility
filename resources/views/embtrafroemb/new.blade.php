...
@section('content')
  ...
  <section class="content">
   <form action="{{route('EmbTraFroEmbStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
          ...
          <div class="card card-primary">
            ...
            <div class="form-group row">
              <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="FrozenEmb" name="FrozenEmb"/>
              </div> 
              <div class="col-md-3">
                <label for="FrozenDate" class="col-form-label">Frozen Date</label>
                <input type="date" class="form-control" id="FrozenDate" name="FrozenDate"/>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-md-3">
                <label for="ThaEmby" class="col-form-label">No of Embryo Thawed</label>
                <input type="text" class="form-control" id="ThaEmby" name="ThaEmby"/>
              </div> 
              <div class="col-md-3">
                <label for="EmbyDate" class="col-form-label">Thawed Date</label>
                <input type="date" class="form-control" id="EmbyDate" name="EmbyDate"/>
              </div>
              <div class="col-md-3">
                <label for="EmbyRem" class="col-form-label">Remaining Embryo</label>
                <input type="text" class="form-control" id="EmbyRem" name="EmbyRem"/>
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-md-3">
                ...
                <input type="text" class="form-control" id="EmbyTran" name="EmbyTran"/>
              </div>
              <div class="col-md-3">
            ...
            <div class="form-group row">
              <div class="col-md-6">
                ...
                <input type="text" class="form-control" id="PatientInit" name="PatientInit"/>
              </div>
              <div class="col-md-3">
                <label for="ET3" class="col-form-label">ET 3</label>
                <input type="text" class="form-control" id="ET3" name="ET3"/>
              </div>
              <div class="col-md-3">
                <label for="ET5" class="col-form-label">ET 5</label>
                <input type="text" class="form-control" id="ET5" name="ET5"/>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-md-4">
                <div class="input-group">
                  ...
                  <input type="text" class="form-control" id="MDName">
                </div>
              </div>
              <div class="col-md-4">
                <div class="input-group">
