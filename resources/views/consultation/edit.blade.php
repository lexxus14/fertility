...
@section('content')
  ...
  <section class="content">
   <form id="quickForm" action="{{route('ConsultationUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="intInCycle" value="{{$result->incycle}}" placeholder="Enter Description">
                    </div>
                    <div class="form-group">
                        <label>Note</label>
              ...
              <div class="row">
                <div class="col-12">
                  <a href="{{route('PatientConsultation')}}/{{$intPatientId}}" class="btn btn-secondary">Cancel</a>
