            ...
            <div class="card-body">
              <div class="row">
                <div class="col-2">
                    <div class="form-group">
                      <label>Date</label>
                      <!-- <input type="text" id="lead-date-input" value="" name=""> -->
                      <input type="text" id="lead-date-input"  class="form-control"  value="" >
              ...
              <div class="row">
                <div class="col-4">
                    ...
                    <div class="form-group">                      
                          <p>FILE: <a href="{{url('/')}}/{{$leadassessment->FileLink}}" target="_blank">{{$leadassessment->FileLink}} </a></p>
                    </div>
                </div>
              </div>   
              <div class="row">
