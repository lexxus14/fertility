...
@section('content')
  ...
  <section class="content">
   <form action="{{route('PatientDoctorDiagnosisUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
    @foreach($docresults as $docresult)
        {{ csrf_field() }}
      <input type="hidden" id="TotalPayableAmount" name="txtTotalPayableAmount" value="0">
      <input type="hidden" name="txtpatientId" value="{{$intPatientId}}">
      <input type="hidden" name="txtPatientDoctorDiagnosisId" value="{{$docresult->id}}">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            @endif
            <div class="card-header">
              <h3 class="card-title">Doctor Diagnosis</h3>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="form-group">
                <div class="col-12">
                  <input type="button" value="Add Doctor's Diagnosis" class="btn btn-success float-right" data-toggle="modal" data-target="#open-modal-medicine-treatment">
                </div>
                </div>
              </div>   
              <div class="row">
                ...
                <!-- /.card-header -->
                    ...
                    <table  class="table table-bordered table-striped">
                      ...
                      $intctr = 0;
                      ?>
                      @foreach($patientdoctordiagnosisssubs as $patientdoctordiagnosisssub)
                      <?php 
                      $intctr++;
                      ?>
                      <tr id="R{{$intctr}}">
                        <td class="row-index text-center">
                        <input type="hidden" class="medid" name="txtdoctorsdiagnosisId[]" value="{{$patientdoctordiagnosisssub->doctordiagnosisId}}">
                          <p>{{$intctr}}</p>
                        </td>
                        <td class="text-center">
                        {{$patientdoctordiagnosisssub->description}}
                        </td>                        
                        <td class="text-center">
                          <textarea class="form-control amount amount{{$patientdoctordiagnosisssub->id}}" name="txtnote[]">{{$patientdoctordiagnosisssub->notes}}</textarea>
                        </td>
                        <td class="text-center">
        ...
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Doctor's Diagnosis</h4>
                ...
                <div class="col-12">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><button type="button" class="btn btn-success add-medicine-treatment" value="{{$doctorDiagnos->id}}">Add</button> </td>
                    </tr>
                    @endforeach
                  </tbody>
                </table>                                 
      ...
      $.get(url + '/' + med_id, function (data) {
        console.log(data);
            $('#tbody').append(`<tr id="R${++rowIdx}">
              <td class="row-index text-center">
              <input type="hidden" class="medid" name="txtdoctorsdiagnosisId[]" value="${data.id}">
                <p>${rowIdx}</p>
              </td>
              <td class="text-center">
              ${data.description}
