...
@section('content')
  ...
  <section class="content">
   <form action="{{route('PatientDoctorDiagnosisStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
      ...
      $.get(url + '/' + med_id, function (data) {
        console.log(data);
            $('#tbody').append(`<tr id="R${++rowIdx}">
              ...
              <input type="hidden" class="medid" name="txtDoctorDiagnosId[]" value="${data.id}">
                <p>${rowIdx}</p>
              </td>
