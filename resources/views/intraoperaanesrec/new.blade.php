...
@section('content')
  ...
  <section class="content">
   <form action="{{route('IntraOperAnesRecsStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" id="quickForm" novalidate="">
        {{ csrf_field() }}
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                ...
                <div class="col-md-2">
                  ...
                  <input type="text" name="PulseRate" id="PulseRate" class="form-control">
                </div>
                <div class="col-md-2">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  ...
                  <input type="text" name="IntraOperativeDiags" id="IntraOperativeDiags" class="form-control">
                </div>
                <div class="col-md-6">
                  <label for="SurgeryName" class="col-form-label">Surgery Name</label>
                  <input type="text" name="SurgeryName" id="SurgeryName" class="form-control">
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <!-- /btn-group -->
                    <input type="hidden" class="form-control" name="SurgeonStaffId" id="SurgeonStaffId" value="0">
                    <input type="text" class="form-control" id="SurgeonStaffName">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <!-- /btn-group -->
                    <input type="hidden" class="form-control" name="AsstSurgeonStaffId" id="AsstSurgeonStaffId" value="0">
                    <input type="text" class="form-control" id="AsstSurgeonStaffName">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-6">
                  <div class="input-group">
                    ...
                    <!-- /btn-group -->
                    <input type="hidden" class="form-control" name="AnesthetistStaffId" id="AnesthetistStaffId" value="0">
                    <input type="text" class="form-control" id="AnesthetistStaffName">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="input-group">  
                    <label for="TypeOfAnesthesia">Type of Anesthesia &nbsp</label>
                    <input type="text" class="form-control" id="TypeOfAnesthesia" name="TypeOfAnesthesia">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-6"> 
                    ...
                    <input type="time" class="form-control" id="AnesthesiaStartTime" name="AnesthesiaStartTime">
                </div>
                <div class="col-md-6">  
                    <label for="SurgeryStartTime">Surgery Start: &nbsp</label>
                    <input type="time" class="form-control" id="SurgeryStartTime" name="SurgeryStartTime">
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-6"> 
                    ...
                    <input type="time" class="form-control" id="AnesthesiaEndTime" name="AnesthesiaEndTime">
                </div>
                <div class="col-md-6">
                    <label for="SurgeryStartTime">Surgery End &nbsp</label>
                    <input type="time" class="form-control" id="SurgeryEndTime" name="SurgeryEndTime">
                </div>
              </div>
...
<script>
  ...
  $(document).ready(function(){
    <?php 
        $ImageBackground ="'".url('css/AnesthesiaTable.png')."'";
    ?>
