    	...
    	<div class="container-fluid">
    		<div class="row">
	          ...
	          <div class="col-md-12">
	            <div class="card">
	              <div class="card-header">
	                <h3 class="card-title"><b>Inter-Operative Anesthesia Record</b></h3>
                  ...
                  <a href="{{route('IntraOperAnesRecsCreate')}}/{{$intPatientId}}" class="btn btn-success float-right" style="margin-right: 5px;">
                    <i class="fas fa-pencil-alt"></i> New
                  </a>
	              </div>
	              <!-- /.card-header -->
	                  ...
	                  <tbody>
                        ...
                        <td>
                          ...
                          @endif
		                    ...
		                    <td>
		                      <a class="btn btn-primary btn-sm float-right" href="{{route('IntraOperAnesRecsShow')}}/{{$result->id}}">
		                        <i class="fas fa-folder"></i>
		                              View
		                      </a>

		                      <a class="btn btn-info btn-sm float-right" href="{{route('IntraOperAnesRecsEdit')}}/{{$result->id}}">
      ...
      <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="POST" action="{{route('IntraOperAnesRecsDelete')}}">
              {{ csrf_field() }}
