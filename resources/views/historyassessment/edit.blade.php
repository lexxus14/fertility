...
@section('content')
  ...
  <section class="content">
   <form id="quickForm" action="{{route('HistoryUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            @endif
            <div class="card-header">
              <h3 class="card-title">Edit History Assessment</h3>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12">
                  <a href="{{route('PatientHistory')}}/{{$intPatientId}}" class="btn btn-secondary">Cancel</a>
