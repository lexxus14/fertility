...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
       <form id="quickForm" action="{{route('LabTestStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="inputPrice" name="txtprice" class="form-control"> 
                </div>                                  
              </div>
