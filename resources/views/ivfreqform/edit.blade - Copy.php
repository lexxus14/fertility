...
@section('content')
  ...
  <section class="content">
   <form id="quickForm" action="{{route('LabInvestigationUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            @endif
            <div class="card-header">
              <h3 class="card-title">Edit Laboratory Investagation</h3>
