...
@section('content')
  ...
  <section class="content">
   <form action="{{route('SpermFreezingStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" id="quickForm" novalidate="">
        {{ csrf_field() }}
            ...
            <div class="card-body">
              ...
              <div class="form-group row">                
                ...
                <div class="col-md-3">
                  ...
                  <input type="text" class="form-control" id="FreezingNo" name="FreezingNo"/>
                </div>
                <div class="col-md-3">
                  <label for="AccnNo" class="col-form-label">Accn NO</label>
                  <input type="text" class="form-control" id="AccnNo" name="AccnNo"/>
                </div>
              </div>
                    ...
                    <div class="card-body table-responsive p-0">
                      <table class="table table-hover text-nowrap">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td>pH</td>
                            <td><input type="number" class="form-control" name="pH"> </td>
                            <td>>= 7.2</td>
                          </tr>
                        </tbody>
                      </table>
              ...
              <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="OfVialsNo">
                    <label for="Tank">Tank</label>
                    <input type="text" class="form-control" name="Tank">
                    <label for="Canister">Canister</label>
                    <input type="text" class="form-control" name="Canister">
                    <label for="Cane">Cane</label>
                    <input type="text" class="form-control" name="Cane">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="SpermVolume">
                    <label for="Conc">Conc .ml</label>
                    <input type="text" class="form-control" name="Conc" placeholder="ml">
                    <label for="Motility">Motility</label>
                    <input type="text" class="form-control" name="Motility">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
