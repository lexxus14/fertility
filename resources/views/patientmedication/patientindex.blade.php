    	...
    	<div class="container-fluid">
    		<div class="row">
	          ...
	          <div class="col-md-12">
	            <div class="card">
	              <div class="card-header">
	                <h3 class="card-title"><b>Patient Medication</b></h3>
                  ...
                  <a href="{{route('PatientMedicationCreate')}}/{{$intPatientId}}" class="btn btn-success float-right open-modal-lead-assessment" style="margin-right: 5px;">
                    <i class="fas fa-pencil-alt"></i> New
                  </a>
	              </div>
	              <!-- /.card-header -->
	                  ...
	                  <tbody>
	                    <?php
		                  ...
		                  <tr>
		                    ...
		                    <td>{{$result->notes}}</td>
		                    <td>
		                      <a class="btn btn-primary btn-sm float-right" href="{{route('PatientMedicationView')}}/{{$result->id}}">
		                        <i class="fas fa-folder"></i>
		                              View
		                      </a>

		                      <a class="btn btn-info btn-sm float-right" href="{{route('PatientMedicationEdit')}}/{{$result->id}}">
      ...
      <div class="modal fade" id="modal-show">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form id="quickForm" action="{{route('PatientMedicationStore')}}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
                ...
                <div class="col-12">
                    ...
                    <div class="form-group">
                      <label>Medicine</label>
                        <select class="form-control select2" name="cmbMedicine" style="width: 100%;">
                           @foreach($medicines as $medicine)
                              <option value="{{$medicine->id}}">{{$medicine->description}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
      ...
      <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="POST" action="{{route('PatientMedicationDelete')}}">
              {{ csrf_field() }}
              <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
