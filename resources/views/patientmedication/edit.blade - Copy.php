...
@section('content')
  ...
  <section class="content">
   <form id="quickForm" action="{{route('PatientMedicationUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            @endif
            <div class="card-header">
              <h3 class="card-title">Edit Pathology / X-Ray</h3>
                ...
                <div class="col-2">
                    ...
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="lead-time-reminder" data-target-input="nearest">
                          <input type="text" class="form-control datetimepicker-input" value="{{$result->time_reminder}}" name="txtLeadTimeReminder" data-target="#lead-time-reminder"/>
                      ...
                      <label>Medicine</label>
                        <select class="form-control select2" name="cmbMedicine" style="width: 100%;">
                           @foreach($medicines as $medicine)
                            @if($result->medicineId == $medicine->id)
                              <option value="{{$medicine->id}}" selected>{{$medicine->description}}</option>
                              @else
