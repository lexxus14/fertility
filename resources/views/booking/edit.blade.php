...
@section('content')
  ...
  <section class="content">
   <form action="{{route('LabInvestigationUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
    @foreach($docresults as $docresult)
        {{ csrf_field() }}
      <input type="hidden" id="TotalPayableAmount" name="txtTotalPayableAmount" value="0">
      <input type="hidden" name="txtpatientId" value="{{$intPatientId}}">
      <input type="hidden" name="txtLabInvestigationId" value="{{$docresult->id}}">
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            @endif
            <div class="card-header">
              <h3 class="card-title">Laboratory Investigation</h3>
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="form-group">
                <div class="col-12">
                  <input type="button" value="Add Lab Test" class="btn btn-success float-right" data-toggle="modal" data-target="#open-modal-medicine-treatment">
                </div>
                </div>
              </div>   
              <div class="row">
                ...
                <!-- /.card-header -->
                    ...
                    <table  class="table table-bordered table-striped">
                      ...
                      $intctr = 0;
                      ?>
                      @foreach($labinvsubs as $labinvsub)
                      <?php 
                      $intctr++;
                      ?>
                      <tr id="R{{$intctr}}">
                        <td class="row-index text-center">
                        <input type="hidden" class="medid" name="txtlabtestId[]" value="{{$labinvsub->labtestid}}">
                          <p>{{$intctr}}</p>
                        </td>
                        <td class="text-center">
                        {{$labinvsub->description}}
                        </td>                        
                        <td class="text-center">
                          <textarea class="form-control amount amount{{$labinvsub->id}}" name="txtnote[]">{{$labinvsub->notes}}</textarea>
                        </td>
                        <td class="text-center">
              ...
              <div class="row">
                <div class="col-12">
                  <a href="{{route('PatientLab')}}/{{$intPatientId}}" class="btn btn-secondary">Cancel</a>
