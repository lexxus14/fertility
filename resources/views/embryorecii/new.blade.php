...
@section('content')
  ...
  <section class="content">
   <form action="{{route('EmbryologyRecordIIStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
                      ...
                      <tr>
                        <th colspan="3" class="text-left">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="date" name="Day0Date" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="time" name="Day0Time" class="form-control">
                            </div>
                          </div>
                            ...
                            <div class="input-group">
                              ...
                              <!-- /btn-group -->
                              <input type="hidden" class="form-control" name="Day0EmbryologistStaffId" id="Day0EmbryologistStaffId" value="0">
                              <input type="text" class="form-control" id="Day0EmbryologistName">
                            </div>
                        ...
                        <th colspan="3" class="text-left">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="date" name="Day1Date" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="time" name="Day1Time" class="form-control">
                            </div>
                          </div>
                            ...
                            <div class="input-group">
                              ...
                              <!-- /btn-group -->
                              <input type="hidden" class="form-control" name="Day1EmbryologistStaffId" id="Day1EmbryologistStaffId" value="0">
                              <input type="text" class="form-control" id="Day1EmbryologistName">
                            </div>
                        ...
                        <th  class="text-left">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="date" name="Day3Date" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="time" name="Day3Time" class="form-control">
                            </div>
                          </div>                     
                            ...
                            <div class="input-group">
                              ...
                              <!-- /btn-group -->
                              <input type="hidden" class="form-control" name="Day3EmbryologistStaffId" id="Day3EmbryologistStaffId" value="0">
                              <input type="text" class="form-control" id="Day3EmbryologistName">
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="time" name="Day3AhTime" class="form-control">
                            </div>
                          </div> 
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" name="Day3AhTech" class="form-control">
                            </div>
                          </div> 
                        ...
                        <th class="text-left">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="date" name="Day5Date" class="form-control">
                            </div>
                          </div> 
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="time" name="Day5Time" class="form-control">
                            </div>
                          </div> 
                            ...
                            <div class="input-group">
                              ...
                              <!-- /btn-group -->
                              <input type="hidden" class="form-control" name="Day5EmbryologistStaffId" id="Day5EmbryologistStaffId" value="0">
                              <input type="text" class="form-control" id="Day5EmbryologistName">
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="time" name="Day5AhTime" class="form-control">
                            </div>
                          </div> 
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" name="Day5AhTech" class="form-control">
                            </div>
                          </div>
                        ...
                        <th class="text-left">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="date" name="Day6Date" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="time" name="Day6Time" class="form-control">
                            </div>
                          </div>
                            ...
                            <div class="input-group">
                              ...
                              <!-- /btn-group -->
                              <input type="hidden" class="form-control" name="Day6EmbryologistStaffId" id="Day6EmbryologistStaffId" value="0">
                              <input type="text" class="form-control" id="Day6EmbryologistName">
                            </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="time" name="Day6AhTime" class="form-control">
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                              <input type="text" name="Day6AhTech" class="form-control">
                            </div>
                          </div>
                      ...
                      <tfoot>
                        ...
                        <th colspan="3"   class="text-left">
                          <div class="form-group row">
                            <div class="col-sm-6">
                              <label>PT Cal:</label>
                              <input type="text" name="Day1PtCall" class="form-control">
                            </div>
                            <div class="col-sm-6">
                              <label>Initial:</label>
                              <input type="text" name="Day1Initial" class="form-control">
                            </div>
                          </div>
                        ...
                        <th  class="text-left">
                            ...
                            <div class="col-sm-6">
                              <label>PT Cal:</label>
                              <input type="text" name="Day3PtCall" class="form-control">
                            </div>
                            <div class="col-sm-6">
                              <label>Initial:</label>
                              <input type="text" name="Day3Initial" class="form-control">
                            </div>
                          </div>
                        ...
                        <th class="text-left">
                          <div class="form-group row">
                            <div class="col-sm-6">
                              <label>PT Cal:</label>
                              <input type="text" name="Day5PtCall" class="form-control">
                            </div>
                            <div class="col-sm-6">
                              <label>Initial:</label>
                              <input type="text" name="Day5Initial" class="form-control">
                            </div>
                          </div>
                        </th>     
                        <th class="text-left">
                          <div class="form-group row">
                            <div class="col-sm-6">
                              <label>PT Cal:</label>
                              <input type="text" name="Day6PtCall" class="form-control">
                            </div>
                            <div class="col-sm-6">
                              <label>Initial:</label>
                              <input type="text" name="Day6Initial" class="form-control">
                            </div>
                          </div>
                        </th>   
                        <th class="text-left">
                  ...
                  <div class="card-body">
                    <div class="form-group row">
                      <div class="col-md-2">
                        ...
                        <input type="text" name="AspLotNo" class="form-control" id="AspLotNo">
                      </div>
                      <div class="col-md-2">
                        <label for="AspExpDate">ASP Date</label>
                        <input type="date" name="AspExpDate" class="form-control" id="AspExpDate">
                      </div>
                      <div class="col-md-2">
                        <label for="ProteinSSSLot">Protein SSS Lot</label>
                        <input type="text" name="ProteinSSSLot" class="form-control" id="ProteinSSSLot">
                      </div>
                      <div class="col-md-2">
                        <label for="ProteinSSSExpDate">Protein SSS Exp Date</label>
                        <input type="date" name="ProteinSSSExpDate" class="form-control" id="ProteinSSSExpDate">
                      </div>
                      <div class="col-md-4">
                        <label>Others</label>
                        <input type="text" name="AspOthers" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <div class="col-md-2">
                        ...
                        <input type="text" name="GlobalLotNo" class="form-control" id="GlobalLotNo">
                      </div>
                      <div class="col-md-2">
                        <label for="GlobalExpDate">Global Date</label>
                        <input type="date" name="GlobalExpDate" class="form-control" id="GlobalExpDate">
                      </div>
                      <div class="col-md-2">
                        <label for="mHTFLotNo">mHTF Lot #</label>
                        <input type="text" name="mHTFLotNo" class="form-control" id="mHTFLotNo">
                      </div>
                      <div class="col-md-2">
                        <label for="mHTFExpDate">mHT FExp Date</label>
                        <input type="date" name="mHTFExpDate" class="form-control" id="mHTFExpDate">
                      </div>
                      <div class="col-md-4">
                        <label>Others</label>
                        <input type="text" name="GlobalOther" class="form-control">
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <div class="col-md-2">
                        ...
                        <input type="text" name="HyluronidaseLogNo" class="form-control" id="HyluronidaseLogNo">
                      </div>
                      <div class="col-md-2">
                        <label for="HyluronidaseExpDate">Hyluronidase Exp Date</label>
                        <input type="date" name="HyluronidaseExpDate" class="form-control" id="HyluronidaseExpDate">
                      </div>
                      <div class="col-md-2">
                        <label for="OilLotNo">Oil Lot No</label>
                        <input type="text" name="OilLotNo" class="form-control" id="OilLotNo">
                      </div>
                      <div class="col-md-2">
                        <label for="OilExpDate">Oil Exp Date</label>
                        <input type="date" name="OilExpDate" class="form-control" id="OilExpDate">
                      </div>
                      <div class="col-md-4">
                        <label>Others</label>
                        <input type="text" name="GlobalOthers" class="form-control">
                      </div>
                    </div>
