...
@section('content')
  ...
  <section class="content">
   ...
   <form action="{{route('OperativeReportUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
              ...
              <div class="form-group row">
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <!-- /btn-group -->
                    <input type="hidden" class="form-control" name="SurgeonId" id="SurgeonId" value="{{$docresult->SurgeonId}}">
