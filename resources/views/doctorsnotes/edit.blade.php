      ...
      <div class="row">
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            @endif
            <div class="card-header">
              <h3 class="card-title">Doctor's Note</h3>
              ...
              <div class="row">
                ...
                <!-- /.card-header -->
                    ...
                    <table  class="table table-bordered table-striped">
                      ...
                      $intctr = 0;
                      ?>
                      @foreach($doctornotessubs as $doctornotessub)
                      <?php 
                      $intctr++;
                      ?>
                      <tr id="R{{$intctr}}">
                        <td class="row-index text-center">
                        <input type="hidden" class="medid" name="txtlabtestId[]" value="{{$doctornotessub->labtestid}}">
                          <p>{{$intctr}}</p>
                        </td>
                        <td class="text-center">
                        {{$doctornotessub->description}}
                        </td>                        
                        <td class="text-center">
                          <textarea class="form-control amount amount{{$doctornotessub->id}}" name="txtnote[]">{{$doctornotessub->notes}}</textarea>
                        </td>
                        <td class="text-center">
