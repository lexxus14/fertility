...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
       <form action="{{route('StaffStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              ...
              <div class="row">
               <div class="col-4">
                  ...
                  <input type="text" id="inputReason" name="txtname" class="form-control">
                </div>
                <div class="col-2">
