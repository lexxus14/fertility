        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              	<a href="{{route('StaffCreate')}}" class="btn btn-primary btn-block"><b>Add New Staff</b></a>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$staf->code}}</td>
                    <td>{{$staf->name}}</td>
                    <td>{{$staf->description}}</td>
                    <td>{{$staf->note}}</td>
                    <td>
                      
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{$staf->id}}">
                        <a href="{{route('StaffEdit')}}/{{$staf->id}}" class=" badge bg-success">Edit</button></a>&nbsp
                        <button type="button" class=" badge bg-danger open-modal-delete" data-toggle="modal" data-target="#modal-delete" value="{{$staf->id}}">Delete</button>
