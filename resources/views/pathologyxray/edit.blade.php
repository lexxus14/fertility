...
@section('content')
  ...
  <section class="content">
   <form id="quickForm" action="{{route('PathologyXrayUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        ...
        <div class="col-md-12">
          <div class="card card-primary">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="col-12">
                  <a href="{{route('PatientPathologyXray')}}/{{$intPatientId}}" class="btn btn-secondary">Cancel</a>
