  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Pathology and X-Ray List</h1>
          </div>
        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              	<a href="{{route('PathologyXrayCreate')}}/1" class="btn btn-primary btn-block"><b>Add New Pathology & X-Ray</b></a>
          ...
          <div class="col-md-9">
          	...
          	<div class="card">
		        <div class="card-header">
		          <h3 class="card-title">Pathology and X-Ray</h3>
		        </div>
