...
@section('content')
  ...
  <section class="content">
   <form action="{{route('PostAnesthesiaRecsStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
              ...
              <div class="form-group row">
                ...
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <!-- /btn-group -->
                    <input type="hidden" class="form-control" name="AnesthetestStaffId" id="AnesthetestStaffId" value="0">
                    <input type="text" class="form-control" id="AnesthetestStaffName">
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="DruInRec" id="DruInRec" rows="5"></textarea>
                  </div>
                </div>                
              </div>
              <hr>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="DisInsAndRem" id="DisInsAndRem" rows="5"></textarea>  
                  </div>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-4">
                  <div class="input-group">
                    ...
                    <!-- /btn-group -->
                    <input type="hidden" class="form-control" name="RecNurStaffId" id="RecNurStaffId" value="0">
                    <input type="text" class="form-control" id="RecNurStaffName">
                  </div>
                </div>
              </div>
