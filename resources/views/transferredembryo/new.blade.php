  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Add New Transferred Embryo</h1>
          </div>
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            <div class="card card-default">
              <div class="card-header">
                <h3 class="card-title">Transferred Embryo Form</h3>
              </div>
              <form action="{{route('TransferredEmbryoStore')}}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
