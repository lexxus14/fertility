        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              	<a href="{{route('TransferredEmbryoCreate')}}/1" class="btn btn-primary btn-block"><b>Add New Transferred Embryo</b></a>
          ...
          <div class="col-md-9">
          	...
          	<div class="card">
		        <div class="card-header">
		          <h3 class="card-title">Transferred Embryo</h3>
		        </div>
		              ...
		              <tbody>
		                  <tr>
		                      ...
		                      <td class="project_progress">
		                          Transferred Embryo 1
		                      </td>
		                      <td class="project-state">
		                          Transferred Embryo Note 1
		                      </td>
