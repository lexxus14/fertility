        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              	<a href="{{route('EggFertilizedCreate')}}/1" class="btn btn-primary btn-block"><b>Add New Eggs Fertilized</b></a>
          ...
          <div class="col-md-9">
          	...
          	<div class="card">
		        <div class="card-header">
		          <h3 class="card-title">Egg Fertilized</h3>
		        </div>
