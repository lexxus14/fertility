...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <form id="quickForm" action="{{route('EggFertilizedUpdate')}}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
                ...
                <div class="row  card card-primary">
                  ...
                  <div class="col-4">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="txtEggsCollected" value="{{$result->EggsFertilized}}">
                    </div>
                  </div>
                  <div class="col-12">
                    <div class="form-group">
                  ...
                  <div class="col-12">
                    <div class="modal-footer justify-content-between">
                      <a href="{{route('PatientEggFertilized')}}/{{$intPatientId}}" class="btn btn-default">Cancel</a>                      
                    </div>
                  </div>
                </div> 
              </div>
