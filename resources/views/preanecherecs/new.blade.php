...
@section('content')
  ...
  <section class="content">
   <form action="{{route('PreAneCheRecsStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
            ...
            <div class="card-body">
              ...
              <div class="form-group row">
                <div class="col-md-6">
                 ...
                 <textarea class="form-control" id="PreAneSurHis" rows="5" name="PreAneSurHis"></textarea> 
                </div>
                <div class="col-md-6">
                 <label for="CurTheraphy">Current Therapy</label>
                 <textarea class="form-control" id="CurTheraphy" rows="5" name="CurTheraphy"></textarea> 
                </div>
              </div>
              <div class="row">                  
                <div class="col-md-6">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  ...
                  <textarea class="form-control" name="PreMedDruInsNote" rows="5"></textarea>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-12">
                  <h3>Anesthesia Plan</h3>
                  <textarea class="form-control" name="AnesthesiaPlan" rows="5"></textarea>
                </div>
              </div>
              <div class="form-group row">
                <div class="col-md-4">
                ...
                <div class="col-md-2">
                  <div class="input-group">
                    ...
                    <input type="date" name="AnesthetistDate" id="AnesthetistDate" class="form-control">
                  </div>
                </div>
                <div class="col-md-2">
                  <div class="input-group">
                    <label for="AnesthetistTime">Time</label>
                    <input type="time" name="AnesthetistTime" id="AnesthetistTime" class="form-control">
                  </div>
                </div>
              </div>           
...
$(function () {
  ...
  <script >
    ...
    $('.add-diagnosis').click(function(){
      ...
      $.get(url + '/' + med_id, function (data) {
        console.log(data);
            $('#tbody_diag').append(`<tr id="R${++rowIdx}">
              <td class="row-index text-center">
