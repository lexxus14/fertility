...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <form id="quickForm" action="{{route('GoodEmbryoUpdate')}}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
                ...
                <div class="row  card card-primary">
                  ...
                  <div class="col-4">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="txtEggsCollected" value="{{$result->GoodEmbryo}}">
                      </div>
                      </div>
                      <div class="col-12">
                      <div class="form-group">
