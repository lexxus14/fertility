...
@section('content')
  ...
  <section class="content">
    <div class="col-md-12">
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><b>Good Embryo</b></h3>
        ...
        <div class="card-body">
          <table id="example1" class="table table-bordered table-striped">
            ...
            <tr>
              ...
              <td>{{$result->Nurse}}</td>
              <td>{{$result->GoodEmbryo}}</td>
              <td>{{$result->Notes}}</td>
              <td>
                <a class="btn btn-primary btn-sm float-right" href="{{route('GoodEmbryoView')}}/{{$result->id}}">
                  <i class="fas fa-folder"></i>
                        View
                </a>
                <a class="btn btn-info btn-sm float-right" href="{{route('GoodEmbryoEdit')}}/{{$result->id}}">
      ...
      <div class="modal fade" id="modal-lead-assessment">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form id="quickForm" action="{{route('GoodEmbryoStore')}}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <form method="POST" action="{{route('GoodEmbryoDelete')}}">
              {{ csrf_field() }}
              <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
