...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
       <form action="{{route('TreatmentStore')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="card-body">
              <div class="form-group">
                <div class="row">
                  ...
                  <div class="col-4">
                    <label for="inputName">Treatment</label>
