...
@section('content')
  ...
  <section class="content">
   <form action="{{route('OOctyeFreezeThawTransUpdateDetails')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
        {{ csrf_field() }}
          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row">
                <div class="form-group">
                <div class="col-12">
                  <input type="button" value="Add Freezing/Thawing" class="btn btn-success float-right" id="AddProcessedSperm">
                </div>
                </div>
              </div>   
              <?php $tableNo =1; ?>
                        ...
                        <tr>
                          ...
                          <td colspan="2"> 
                            <div class="input-group">
                              ...
                              <!-- /btn-group -->
                              <input type="hidden" class="form-control" name="FreezingEmbStaffId" id="FreezingEmbStaffId" value="{{$OOcyteSub->FreezingEmbStaffId}}">
                          ...
                          <td colspan="2"> 
                            <div class="input-group">
                              ...
                              <!-- /btn-group -->
                              <input type="hidden" class="form-control" name="ThawingEmbStaffId" id="ThawingEmbStaffId" value="{{$OOcyteSub->ThawingEmbStaffId}}">
