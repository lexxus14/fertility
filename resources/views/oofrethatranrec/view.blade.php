                    ...
                    <table  class="table table-bordered table-striped">
                      ...
                      <?php $intctr=1; ?>
                        ...
                        <tr id="R${++rowIdx}">
                          ...
                          <td class="text-left">
                              <div class="form-group">
                              <input type="hidden" value="0" name="IsThawYes[]"  id="IsThawYes${rowIdx}" value="{{$OOcyteSub->IsThawYes}}">
                              ...
                              <div class="form-group">
                              <input type="hidden" value="0" name="IsThawNo[]"  id="IsThawNo${rowIdx}" value="{{$OOcyteSub->IsThawYes}}">
                                <div class="icheck-success d-inline">
