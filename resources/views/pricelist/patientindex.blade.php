        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              	<a href="{{route('PriceListCreate')}}/1" class="btn btn-primary btn-block"><b>Add New Price List</b></a>
                ...
                <div class="input-group" data-widget="sidebar-search">
				          <input class="form-control form-control-sidebar" type="search" placeholder="Search Price List" aria-label="Search">
