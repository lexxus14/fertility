...
@section('content')
  ...
  <section class="content">
   <form action="{{route('PriceListUpdate')}}" method="POST" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
    @foreach($pricelists as $pricelist)
        {{ csrf_field() }}
      <input type="hidden" id="TotalPayableAmount" name="txtTotalPayableAmount" value="0">
      <input type="hidden" name="txtpatientId" value="{{$intPatientId}}">
      <input type="hidden" name="txtPriceListId" value="{{$pricelist->id}}">
                ...
                <div class="col-2">
                    <div class="form-group">
                      ...
                      <div class="input-group date" id="lead-date" data-target-input="nearest">
                          ...
                          <script>
                          const d = new Date("{{$pricelist->pricelistdate}}");
              ...
              <div class="row">
                ...
                <!-- /.card-header -->
                    ...
                    <table  class="table table-bordered table-striped">
                      ...
                      $intctr = 0;
                      ?>
                      @foreach($pricelistssub as $pricelistsub)
                      <?php 
                      $intctr++;
                      ?>
                      <tr id="R{{$intctr}}">
                        <td class="row-index text-center">
                        <input type="hidden" class="medid" name="txtMedicineId[]" value="{{$pricelistsub->medicineid}}">
                          <p>{{$intctr}}</p>
                        </td>
                        <td class="text-center">
                        {{$pricelistsub->description}}
                        </td>
                        <td class="text-center">
                          <input type="text" class="med-qty med-qty{{$pricelistsub->medicineid}}" name="txtqty[]" value="{{$pricelistsub->qty}}">
                        </td>
                        <td class="text-center">
                          <input type="text" class="amount amount{{$pricelistsub->medicineid}}" name="txtamount[]" value="{{$pricelistsub->amount}}">
                        </td>
                        <td class="text-center">
                          <input type="text" class="med-total-amount med-total-amount{{$pricelistsub->medicineid}}" name="txtTotalAmount[]" value="{{$pricelistsub->total_amount}}">
                        </td>
                        <td class="text-center">
                      ...
                      <tfoot>
                        <tr>
                           ...
                           <td></td>
                           <td></td>
                           <td class="text-center">{{$pricelist->total_amount}}</td>
                        </tr>
                      </tfoot>                 
                    </table>
                <!-- /.card-body -->
              ...
              <div class="row">
                <div class="col-4">
                  <div class="form-group">
                      <div class="form-group">
                        <label>Note</label>
                        <textarea id="inputNoteLead-Edit" name="txtnotepricelist" class="form-control" rows="4">{{$pricelist->notes}}</textarea>
                      </div>                      
                    </div>
                </div>
              </div>
