          ...
          <div class="card card-primary">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-2">
                    <div class="form-group">                      
                          <p>Date: {{$pricelists->pricelistdate}}</p>                     
                    </div>
                </div>
              </div>
              <div class="row">
              ...
              <div class="row">
                ...
                <!-- /.card-header -->
                    ...
                    <table  class="table table-bordered table-striped">
                      ...
                      ?>
                      <tr>
                        <td class="text-center">{{$intctr}}</td>
                        <td class="text-center">{{$pricelistsub->description}}</td>
                        <td class="text-center">{{$pricelistsub->qty}}</td>
                        <td class="text-center">{{$pricelistsub->amount}}</td>
                        <td class="text-center">{{$pricelistsub->total_amount}}</td>
                      </tr>
                      @endforeach    
                      </tbody> 
                      <tfoot>
                        <tr>
                           ...
                           <td></td>
                           <td></td>
                           <td class="text-center">{{$pricelists->total_amount}}</td>
                        </tr>
                      </tfoot>                 
                    </table>
                <!-- /.card-body -->                  
