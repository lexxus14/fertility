...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <form id="quickForm" action="{{route('BiopsyResultUpdate')}}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
                ...
                <div class="row  card card-primary">
                  ...
                  <div class="col-4">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="txtNormalEmbryo" value="{{$result->NormalEmbryo}}">
                      </div>
                      <div class="form-group">
                        <label>Abnormal Embryo</label>
                        <input type="text" class="form-control" name="txtAbnormalEmbryo" value="{{$result->AbnormalEmbryo}}">
                      </div>
                      <div class="form-group">
                        <label>Number Of Male</label>
                        <input type="text" class="form-control" name="txtNumberOfMale" value="{{$result->NumberOfMale}}">
                      </div>
                      <div class="form-group">
                        <label>Number Of Female</label>
                        <input type="text" class="form-control" name="txtNumberOfFemale" value="{{$result->NumberOfFemale}}">
                      </div>
                    </div>
                      <div class="col-12">
                      <div class="form-group">
                    ...
                    <div class="col-12">
                      <div class="modal-footer justify-content-between">
                        <a href="{{route('PatientBiopsyResult')}}/{{$intPatientId}}" class="btn btn-default">Cancel</a>
